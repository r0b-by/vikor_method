...
<div id="normalisasiterbobot" class="flex flex-wrap -mx-3">
    <div class="flex-none w-full max-w-full px-3 overflow-x-hidden">
        <div
            ...
            <div class="flex justify-between p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                <div>
                    <h6 class="dark:text-white">Normalisasi Perkalian Nilai Matriks Terbobot</h6>
                    ...
                    <div class="mt-2 text-sm space-x-3">
                        ...
                        <a href="{{ route('hitung.normalisasi') }}" class="text-blue-600 hover:underline">Ke Normalisasi Matriks</a>
                        <a href="{{ route('hitung.selisihideal') }}" class="text-blue-600 hover:underline">Ke Nilai Ideal</a>
                        <a href="{{ route('hitung.utility') }}" class="text-blue-600 hover:underline">Ke Utility S dan R</a>
                        <a href="#qi" class="text-blue-600 hover:underline">Ke Nilai Kompromi Qi</a>
                    </div>
                </div>
            </div>
                        ...
                        <thead class="align-bottom">
                            <tr>
                                ...
                                @foreach ($criteria as $c)
                                    <th class="px-6 py-3 font-bold text-left uppercase ...">
                                        {{ $c->criteria_code }}
                                    </th>
                                @endforeach
                            </tr>
