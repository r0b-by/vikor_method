...
<a fixed-plugin-button
   class="fixed px-4 py-2 text-xl bg-white shadow-lg cursor-pointer bottom-8 right-8 z-990 rounded-circle text-slate-700">
    ...
    class="fixed top-0 left-auto z-sticky w-90 h-full px-2.5 bg-white/80 dark:bg-slate-850/80 backdrop-blur-2xl backdrop-saturate-200 shadow-3xl rounded-none border-0 bg-clip-border flex flex-col break-words min-w-0 ease-in-out duration-200 -right-90">
        ...
        <div class="flex-auto p-6 pt-0 overflow-auto sm:pt-4">
            ...
            <div class="flex">
                ...
                <button transparent-style-btn
                    ...
                    data-class="bg-transparent">Dark</button>
            </div>
